...
// if (pathname == 'our_service'){
//     $('.mil-frame-top').css('background' , '#2F0052')
// }else{
//     $('.mil-frame-top').css('background', 'none');
// }
// document.addEventListener('DOMContentLoaded', () => {
//     Fancybox.bind("[data-fancybox='gallery']", {
//         infinite: true,
//         keyboard: true,
//         buttons: ["slideShow", "thumbs", "zoom", "close"], // Customize buttons
//     });
// });
...
// if (pathname.includes('/our_service')) {
//     window.addEventListener("pageshow", function (event) {
//         if (event.persisted) {
//             location.reload();
//         }
...
const header = document.querySelector('.mil-frame-top');
window.addEventListener('scroll', () => {
    if (window.scrollY > 50) {
        header.classList.add('fixed');
        $('.mil-frame-top .berry_logo1').css({position: 'absolute', top: '-30%'});
...
$(document).ready(function () {
    $(document).on('click', '.mil-accordion-group', function (e) {
        e.preventDefault();
        let type = $(this).attr('data-type');
        console.log(type);
        $('.submodules').hide();
        $('#submodules_'+type).show();

    });
    $(document).on('click', '.ridlink', function(e){
        e.preventDefault();
...
$(document).ready(function () {
     ...
     $(document).on('click', '.submodule-active-icon', function () {
        $('.mil-accordion-head').removeClass('sub-list-active');
        $('.submodule-svg').hide();
        $(this).find('.mil-accordion-head').addClass('sub-list-active');
        $(this).find('.submodule-svg').show();
    });
...
//             var reader = new FileReader();
//             $(reader).on("load", function() {
//                 $preview.append($("<img/>", { src: this.result, height: 80, style:"opacity: 1;" }));
//             });
//             reader.readAsDataURL(file);
//         }
//     }
...
$(function () {
    ...
    ***************************/
    ...
    var menu = ['<div class="mil-custom-dot mil-slide-1"></div>', '<div class="mil-custom-dot mil-slide-2"></div>', '<div class="mil-custom-dot mil-slide-3"></div>', '<div class="mil-custom-dot mil-slide-4"></div>', '<div class="mil-custom-dot mil-slide-5"></div>']
    ...
    ***************************/
    ...
    var swiper = new Swiper('.mil-1-slider', {
        ...
        breakpoints: {
          768: {
            slidesPerView: 2, // Example for tablets
            spaceBetween: 20,
          },
          576: {
