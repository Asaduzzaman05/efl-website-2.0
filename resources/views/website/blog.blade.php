...
<div data-elementor-type="wp-page" data-elementor-id="86" class="elementor elementor-86 web-blog">
                            ...
                            <div class="elementor-element elementor-element-ef6e5c9 elementor-align-left elementor-widget elementor-widget-bdevs-blog-grid-2" data-id="ef6e5c9" data-element_type="widget" data-widget_type="bdevs-blog-grid-2.default">
                                <div class="elementor-widget-container">
                                    <div class="col-md-12 works">
                                        <div class="row">
                                            <div class="col-md-12 container events-top-slider" style="">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="col-md-12" style="height:150px;top:20%;position:relative;left:15px">
                                                                        <span style="color: #E35D5D;font-size:45px"></span>
                                                                        <p class="text-white">
                                                                            <span style="font-size:35px !important;color:#E35D5D">{{ $day}}</span> <span>{{ $month }}</span> <br>
                                                                           <span style="font-size: 14px !important;"> {!! \Illuminate\Support\Str::limit($blog->title ?? '', 30, '...') !!}</span>
                                                                        </p>
                                                                    </div>
                                                                    <a href="{{ route('blog.details', ['id' => $blog->id]) }}"><button  class="btn btn-danger btn-readmore-small " style="position: relative;left:15px;">read more &gt;&gt;</button></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            @foreach ($blogs as $blog)
                                                @php
                                                    ...
                                                    $day = $d->format('d');
                                                    $month = $d->format('M Y');
                                                    // $day = date('Y', strtotime($blog->date));
                                                    // $year = $blog->updated_at->format('y');
                                                    // dd($day);
                                                @endphp
                                            ...
                                            <div class="col-lg-6 col-md-6 mb-25">
                                                <div class="item">
                                                   <a href="{{ route('blog.details', ['id' => $blog->id]) }}">
                                                    <div class="img">
                                                        ...
                                                        <img style="height: 50vh" decoding="async" src="{{ asset( $blog->image_path) }}" alt="">
                                                ...
                                                <div class="wrapper2">
                                                    ...
                                                    <div class="con">
                                                        <div class="category">
                                                            <i class="fa-regular fa-user"></i><a href="{{ route('blog.details', ['id' => $blog->id]) }}" title="Posts by admin" rel="author">admin</a>                                <i class="fa-regular fa-tag"></i><ul class="post-categories">
                                                            <li><a href="{{ route('blog.details', ['id' => $blog->id]) }}" rel="category">Website</a></li></ul>
                                                        </div>
                                                        <div class="text">
                                                            <a href="{{ route('blog.details', ['id' => $blog->id]) }}">{{ $blog->title ?? '' }}</a>
                                                        </div>
                                                        <a href="{{ route('blog.details', ['id' => $blog->id]) }}" class="icon-btn"><i class="fa-sharp fa-light fa-arrow-right"></i></a>
                                                    </div>
                                                </a> --}}
                                                 <div class="container">
                                                    <a href="{{ route('blog.details', ['id' => $blog->id]) }}"><h6 style="color:#dc2751;font-size:16px !important;position: relative;top:10px;line-height:1.2;font-weight:700;">{{ $blog->title }}</h6>
                                                    {{-- <p class="text-white blog-desc">
                                                       {!! \Illuminate\Support\Str::limit($blog->description ?? '', 180, '...') !!}
                                                    </p> --}}
                                        ...
                                        {{-- <div class="row">
                                            <div class="col-md-12 mt-60 text-center">
                                                ...
                                                <a class="page-numbers" href="index2125.html?page_id=86&amp;paged=2">2</a>
                                                <a class="next page-numbers" href="index2125.html?page_id=86&amp;paged=2"><i class="fa-solid fa-caret-right"></i></a>
                                            </div>
                                        </div> --}}
                                    </div>
                                    </section>
...
<div class="col-md-12 trend-mood" style="">

   <div class="container">
    <p class="text-white" style="padding-top: 20px;">TRENDS MOOD BOARDS </p>
    <div class="row">
        <div class="col-md-6">
            <div class="col-md-12" style="min-height:400px;background:#9798A0">
                <img src="{{ asset('public/website/assets/images/background/help-picure-2.png') }}" alt="" class="trends-mood-picture">
            </div>
        </div>
        <div class="col-md-6" >
            <div class="col-md-12" style="min-height:400px;background:#9798A0">
                <img src="{{ asset('public/website/assets/images/background/help-picure-3.png') }}" alt="" class="trends-mood-picture">
            </div>
        </div>
    </div>
   </div>
