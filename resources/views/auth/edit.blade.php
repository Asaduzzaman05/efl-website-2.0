   ...
   <div class="container ">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body table-card-body p-3 mytable-body">
            ...
            <form id="customer_form" action="{{ route('user.update', $user->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
...
<script>
    ...
    document.getElementById("previewImage").src="{{ asset('public/'.$item->image) }}";
</script>
