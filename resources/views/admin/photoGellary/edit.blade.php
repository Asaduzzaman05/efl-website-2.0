    ...
    <main>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header py-1"><span style="font-size: 14px;
                            font-weight: 600;
                            color: #0e2c96;">Create News</span> </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="photo_name" value="{{ $photos->photo_name }}"
                                            ...
                                            <div class="col-md-4">
                                                <strong><label>Created Date</label><span class="color-red">*</span> <span
                                                        class="my-label">:</span> </strong>
                                            </div>

                                            <div class="col-md-8">
                                                <input type="date" name="date" value="{{ $photos->created_date  }}"
                                                    placeholder="Publish Date"
                                                    class="form-control my-form-control @error('date') is-invalid @enderror" >
                                                @error('date')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="col-md-4">
                                                <strong><label>Description</label><span class="color-red">*</span>
                                                    <span class="my-label">:</span> </strong>
                                            </div>
                                            <div class="col-md-8 mt-1">
                                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description"
                                                    cols="30" rows="3">{{ $photos->description }}</textarea>
                                                @error('description')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
        ...
        @push('admin-js')
            ...
            <script>
                ...
                document.getElementById("previewImage").src = "{{ asset('public/uploads/photoGellary/'.$photos->image) }}";
            </script>
